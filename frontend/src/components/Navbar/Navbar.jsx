          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden xl:flex items-center justify-center space-x-1 flex-1">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-4 w-[900px] bg-white text-[#0B1F3A] rounded-3xl shadow-2xl border border-gray-200 p-8 opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-300">
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    {programs.map((program, index) => (
                      <a
                        key={index}
                        href={program.link}
                        className="group relative p-6 rounded-2xl border border-gray-200 hover:border-gray-300 transition-all duration-500 hover:shadow-xl hover:-translate-y-2 bg-gradient-to-br from-white to-gray-50 overflow-hidden"
                      >
                        {program.badge && (
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full right-0 mt-4 w-96 bg-white text-[#0B1F3A] rounded-2xl shadow-2xl border border-gray-200 p-6 opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-300">
                  <div className="space-y-2">
